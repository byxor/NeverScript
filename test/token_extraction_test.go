...
func TestExtractingTokens(t *testing.T) {
	entries := []struct {
		...
		{[]byte{0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, tokens.RandomRange},
		{[]byte{0x30, 0x12, 0x34, 0x56, 0x78, 0xbb, 0xee, 0xcc, 0xff}, tokens.RandomRange},
		// Invalid RandomRange (not enough bytes)
		{[]byte{0x30, 0x12, 0x34, 0x56, 0x78, 0xbb, 0xee, 0xcc}, tokens.Invalid},
		{[]byte{0x30, 0x12, 0x34, 0x56, 0x78, 0xbb, 0xee}, tokens.Invalid},
		{[]byte{0x30, 0x12, 0x34, 0x56, 0x78, 0xbb}, tokens.Invalid},
		{[]byte{0x30, 0x12, 0x34, 0x56, 0x78}, tokens.Invalid},
		{[]byte{0x30, 0x12, 0x34, 0x56}, tokens.Invalid},
		{[]byte{0x30, 0x12, 0x34}, tokens.Invalid},
		{[]byte{0x30, 0x12}, tokens.Invalid},
