...
func TestExtractingTokens(t *testing.T) {
	entries := []struct {
		...
		// Invalid vectors (not enough bytes)
		{[]byte{
			0x1E, 0xFF, 0xFF, 0xFF, 0xFF,
			0x12, 0x34, 0x56, 0x78,
			0xEC, 0xCE, 0xEC,
		...
		{[]byte{0x1E, 0xFF, 0xFF, 0xFF, 0xFF}, tokens.Invalid},
		{[]byte{0x1E, 0xFF, 0xFF, 0xFF}, tokens.Invalid},
		{[]byte{0x1E, 0xFF, 0xFF}, tokens.Invalid},
		{[]byte{0x1E, 0xFF}, tokens.Invalid},
		{[]byte{0x1E}, tokens.Invalid},
		...
		{[]byte{0x2B, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00}, tokens.NameTableEntry},
		{[]byte{0x2B, 0x11, 0x22, 0x33, 0x44, 0x43, 0x6F, 0x63, 0x6B, 0x00}, tokens.NameTableEntry},
		// Invalid name table entries (not enough bytes)
		...
		// Invalid name table entries (not null-terminated)
		...
		{[]byte{
			...
			0x20, 0x00, 0x00, 0x00, // offset to 3rd code block
		...
		{[]byte{0x30, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, tokens.RandomRange},
		{[]byte{0x30, 0x1F, 0x12, 0x34, 0x56, 0x78, 0xbb, 0xee, 0xcc, 0xff}, tokens.RandomRange},
		// Invalid RandomRange (not enough bytes)
		{[]byte{0x30, 0x1F, 0x12, 0x34, 0x56, 0x78, 0xbb, 0xee, 0xcc}, tokens.Invalid},
		{[]byte{0x30, 0x1F, 0x12, 0x34, 0x56, 0x78, 0xbb, 0xee}, tokens.Invalid},
		{[]byte{0x30, 0x1F, 0x12, 0x34, 0x56, 0x78, 0xbb}, tokens.Invalid},
		{[]byte{0x30, 0x1F, 0x12, 0x34, 0x56, 0x78}, tokens.Invalid},
		{[]byte{0x30, 0x1F, 0x12, 0x34, 0x56}, tokens.Invalid},
		{[]byte{0x30, 0x1F, 0x12, 0x34}, tokens.Invalid},
		{[]byte{0x30, 0x1F, 0x12}, tokens.Invalid},
		{[]byte{0x30, 0x1F}, tokens.Invalid},
		{[]byte{0x30}, tokens.Invalid},
...
func TestExtractingMultipleTokens(t *testing.T) {
	entries := []struct {
		...
		}, []tokens.TokenType{tokens.Name, tokens.NameTableEntry}},
